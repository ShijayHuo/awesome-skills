...
- [/key-decision-vetting](./skills/key-decision-vetting/SKILL.md) - A finite, high-signal design review that pressure-tests the most consequential decisions, sharpens domain terminology, and syncs the results into `CONTEXT.md` and architecture decision records (ADRs). This skill is optimized based on [Mattpocock: Grill with doc](https://github.com/mattpocock/skills/blob/main/skills/engineering/grill-with-docs/SKILL.md).
- [/code-implement](./skills/code-implement/SKILL.md) - Adding features, modifying existing code, or refactoring implementation logic, while using the project's `CONTEXT.md` and relevant ADRs to assess complexity and risk and choose an appropriate change strategy. This skill currently follows this repository's local skill document and references [antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills/blob/main/skills/clean-code/SKILL.md) and [Mattpocock: TDD](https://github.com/mattpocock/skills/blob/main/skills/engineering/tdd/SKILL.md).
- [/code-review](./skills/code-review/SKILL.md) - Code review to verify whether the implementation matches the feature requirements and whether the code follows standards such as naming, architecture layering, component conventions, and so on. This skill comes entirely from [Mattpocock: Code Review](https://github.com/mattpocock/skills/blob/2ab958093e83e0ec752e6c1c5932da465bf23e0c/skills/engineering/code-review/SKILL.md).
