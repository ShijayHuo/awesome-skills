...
- [/code-implement](./skills/code-implement/SKILL.md) - Direct-by-default implementation workflow for code changes. It plans first, asks for confirmation only when interface or risk requires it, applies tests proportionally, and keeps refactoring scoped to the current change. This skill comes entirely from this repository's local skill document.
...
- [/clean-code](./skills/clean-code/SKILL.md) - Clean up code based on the principles of *Clean Code*. This skill comes entirely from this repository's local skill document, currently imported from [antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills/blob/main/skills/clean-code/SKILL.md).
